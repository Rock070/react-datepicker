...
export const DateRangeContext = createContext<DateRangeContextKey | null>(null)
...
const _useDatesBody = () => {
  ...
  const { date, setDate, displayDate, setDisplayDate } = ctx
